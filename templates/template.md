...
links:
  ...
  codewiki: "CodeWiki URL（オープンソースの場合）"
...
* **アーキテクチャ**: (例: ローカルファーストのクライアント・サーバー構成、クラウド完結型SaaS、等)
* **主要コンポーネントとデータフロー**: 
  * (データがどこに保存され、どのように処理されるか)
* **特筆すべき要素技術**:
  * (内部で使われている代表的なプロトコルや技術、隔離方法など)
