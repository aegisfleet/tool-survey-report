...
* **Free**:
    * 料金: 無料
    * タスク数: 100タスク/月
    * 機能: 無制限のZap、Tables, Interfaces, AIツールへのアクセス
* **Pro**:
    * 料金: $19.99/月〜 (年払い、14日間の無料トライアルあり)
    * タスク数: 750タスク/月〜
    * 機能: マルチステップZap、プレミアムアプリ連携、Filters, Paths, Formatterなどの高度なツール
* **Team**:
    * 料金: $69/月〜 (年払い、14日間の無料トライアルあり)
    * 機能: Proプランの全機能に加え、共有フォルダ、ユーザーロールと権限設定、SAML SSO
* **Enterprise**:
    * 料金: 要問い合わせ
    * 機能: Teamプランの全機能に加え、エンタープライズ級のセキュリティ、ガバナンスツール、利用状況分析、専任のテクニカルアカウントマネージャー
...
* **2025年12月**:
    ...
    * **Zapier Agentsの機能強化**: SOC 2対応の最終段階に入り、データ管理を強化。また、エージェントのバージョン管理（下書き・公開）機能や、トラブルシューティング機能が改善された。
...
* **2025年11月**:
    ...
    * **Lead Router**: 期間限定でタスクフリーでの利用が可能になった。
