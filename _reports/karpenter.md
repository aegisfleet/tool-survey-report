...
quick_summary:
  ...
  target_users:
    ...
    - "SRE"
    - "プラットフォームエンジニア"
  latest_highlight: "2026年1月にv1.8.2をリリース。継続的なバグ修正と安定性向上を実施。"
  update_frequency: "高"
...
* **2025-10-08**: v1.8.0 - **Pod Level Resources**のサポートや、**Static Capacity**機能の追加など、リソース管理の柔軟性が向上しました。
* **2025-09-15**: v1.7.0 - **Node Overlay CRD**の追加や、ノードライフサイクル管理の改善が行われました。
