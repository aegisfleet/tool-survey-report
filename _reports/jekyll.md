...
quick_summary:
  ...
  target_users:
    ...
    - ブロガー
    - 技術ライター
  latest_highlight: 2025年1月のv4.4.1リリース以降、目立ったアップデートは行われていない
  update_frequency: 低
evaluation:
  score: 72
  base_score: 70
  ...
  minus_points:
    ...
    - point: -2
      reason: 近年アップデートが停滞気味であり、モダン機能への対応が遅れがち
...
* **2025-01-29: v4.4.1**
  * フロントマターのデフォルトにおけるglobパスの動作を復元 (#9762)。
* **2025-01-27: v4.4.0**
...
* **2023-12-28: v3.9.4**
  * Ruby 3 への互換性対応 (Webrickの依存関係追加等)。
* **2023-12-27: v4.3.3**
  * Loggerの互換性問題修正、Structの初期化対応等の開発環境向け修正。
...
| **拡張性** | テーマ/プラグイン | ◎<br><small>非常に豊富</small> | ◯<br><small>豊富</small> | ◎<br><small>エコシステム拡大中</small> | ◎<br><small>圧倒的</small> |
| **パフォーマンス** | ビルド速度 | △<br><small>遅め</small> | ◎<br><small>爆速</small> | ◯<br><small>高速</small> | -<br><small>動的生成</small> |
| **モダン機能** | 最新画像フォーマット(AVIF等) | △<br><small>要プラグイン</small> | ◎<br><small>ネイティブ対応</small> | ◎<br><small>API充実</small> | ◯<br><small>標準サポート</small> |
