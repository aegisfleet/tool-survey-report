...
quick_summary:
  has_free_plan: true
  is_oss: false
  starting_price: $32/月 (100k LOC)
  target_users:
    - 開発者
    - スタートアップ
    - DevOpsチーム
  latest_highlight: Gitar買収によるAIコードレビュー強化とAI機能（Agentic Analysis, MCP Serverなど）の追加
  update_frequency: 高
evaluation:
  score: 88
  base_score: 70
...
| **基本機能** | 静的解析 (SAST) | ◎ | ◎ | ◯ | ◎ |
| **AI機能** | AI修正/自動生成 | ◎<br><small>AI CodeFix等を提供</small> | ◎<br><small>AI CodeFix等を提供</small> | ◯<br><small>Snyk Codeの自動修正</small> | ◎<br><small>Copilot Autofix</small> |
| **セキュリティ** | 脆弱性検知 | ◯ | ◯ | ◎ | ◎ |
