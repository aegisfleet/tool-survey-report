...
* **2025-08-13**: **TensorFlow 2.20.0**
  * tensorflow-io-gcs-filesystemパッケージが任意に。tf.data.Optionsにautotune.min_parallelismを追加。tf.liteが非推奨となり、Google AI Edge LiteRTプロジェクトへの移行を開始。
* **2025-08-13**: **TensorFlow 2.19.1**
  * Serving embeddingに関するバグ修正およびSparseCore Reshardの追加など。
