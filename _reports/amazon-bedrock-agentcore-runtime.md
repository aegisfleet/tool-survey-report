...
* **2026-03-17**: AgentCoreによる、高度なネットワーク運用エージェントの構築事例やベストプラクティスが公開。(出典: [AWS News Blog](https://aws.amazon.com/jp/blogs/news/building-intelligent-network-operations-agent-with-amazon-bedrock-agentcore/))
* **2026-03-09**: AgentCoreポリシーなどがAWS Weekly Roundupで発表。(出典: [AWS News Blog](https://aws.amazon.com/jp/blogs/news/aws-weekly-roundup-amazon-connect-health-bedrock-agentcore-policy-gameday-europe-and-more-march-9-2026/))
* **2026-02-27**: 住信 SBI ネット銀行における、AgentCoreを活用したAI銀行サービス「NEOBANK ai」の導入事例が公開。(出典: [AWS News Blog](https://aws.amazon.com/jp/blogs/news/sbi-sumishin-net-bank-aiagent-application-on-aws/))
* **2025-10-13**: **一般提供開始 (GA)**: プレビューを経て正式リリース。MCPサーバー接続、IAM認証サポート、Observabilityの強化などが含まれる。(出典: [AWS News Blog](https://aws.amazon.com/about-aws/whats-new/2025/10/amazon-bedrock-agentcore-available/))
