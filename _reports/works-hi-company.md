...
quick_summary:
  ...
  target_users:
    - 大企業
    - 人事部
  latest_highlight: 2026年8月にKDDI、ヤマト運輸などの大手企業が統合人事システム「COMPANY」を相次いで採用
  update_frequency: 中
evaluation:
  score: 77
  base_score: 70
...
* **アーキテクチャ**: クラウド完結型SaaS
* **主要コンポーネントとデータフロー**:
  * 従業員や管理者がWebブラウザからアクセスし、クラウド上のシステムでデータが一元管理される。
  * 人事管理、給与計算、勤怠管理などの各シリーズが同一のデータベース基盤上で連携し、情報のリアルタイムな同期を実現。
* **特筆すべき要素技術**:
  * 既存の基幹システムとの連携を想定した充実したAPI。
  * 高いセキュリティ基準を満たすクラウドインフラ基盤。

```mermaid
graph TD
    A[従業員・管理者] -->|Webブラウザ| B(COMPANY フロントエンド)
    B --> C{COMPANY 統合プラットフォーム}
    C --> D[人事管理シリーズ]
    C --> E[給与計算シリーズ]
    C --> F[勤怠管理シリーズ]
    C --> G[タレントマネジメントシリーズ]
...
* **2026-08-26**: KDDI、統合人事システム「COMPANY」を採用
* **2026-08-24**: ひとまいるグループ、約5,500名の人財基盤に「COMPANY」を採用
* **2026-08-04**: ヤマト運輸、統合人事システム「COMPANY」を採用
...
| 機能カテゴリ | 機能項目 | COMPANY | SmartHR | KING OF TIME | ジョブカン勤怠管理 |
|:---:|:---|:---:|:---:|:---:|:---:|
| **基本機能** | 業務網羅性 | ◎<br><small>極めて広い</small> | ◯<br><small>労務中心</small> | △<br><small>勤怠特化</small> | △<br><small>勤怠・シフト中心</small> |
| **カテゴリ特定** | 複雑要件対応 | ◎<br><small>大企業向け</small> | ◯<br><small>標準的</small> | ◎<br><small>カスタマイズ強</small> | ◯<br><small>シフト等に柔軟</small> |
| **エンタープライズ** | セキュリティ | ◎<br><small>金融・自治体</small> | ◎<br><small>認証取得済</small> | ◯<br><small>ISMS等</small> | ◯<br><small>ISMS等取得</small> |
| **非機能要件** | UI/UX | △<br><small>改善余地あり</small> | ◎<br><small>非常に高い</small> | △<br><small>やや古い</small> | ◯<br><small>シンプル</small> |
...
| **ジョブカン勤怠管理** | 必要な機能を選べるクラウド勤怠 | コストパフォーマンスとシフト管理機能の強さ、LINE/Slack打刻 | 管理者画面のUIがやや煩雑 | コストを抑えたい企業、シフト管理が重要なサービス業、柔軟な打刻方法を求める企業 |
