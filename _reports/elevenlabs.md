...
* **低評価・改善点**:
  ...
  * 「日本語の漢字の読み間違いがたまにある（辞書登録機能などで対応可能）」

## **13. 直近のアップデート情報**

* **2025-11-29**: 本レポート作成。
* **Iconic Marketplace**: マイケル・ケインら著名人の公認ボイスを利用できるマーケットプレイスが開設された。
* **Image & Video連携**: 生成した動画（Sora, Veoなど）に対して、最適な音声や効果音を付与するワークフローの統合が進んでいる。
* **Agents Platform**: 会話型AIエージェント構築プラットフォームが正式に展開され、低遅延での対話が可能になった。
* **ElevenReader**: 記事や書籍を高品質なAI音声で聴けるモバイルアプリ(iOS/Android)がリリースされた。
