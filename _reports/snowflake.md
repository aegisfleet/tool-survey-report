...
quick_summary:
  ...
  target_users:
    ...
    - データエンジニア
    - データサイエンティスト
  latest_highlight: 2026年8月にSnowflake Native AppsのCortex AgentsとMCPサーバーが一般提供開始
  update_frequency: 高
evaluation:
  score: 87
  base_score: 70
...
* **Snowflake Cortex**: 高度な機械学習モデル（LLMを含む）をプラットフォームにネイティブ統合し、SQLやPythonで簡単にAI機能を利用できます。AIエージェント機能（Cortex Agents）も一般提供されています。
...
* **2026-08-07**: Snowflake Native AppsにおけるCortex AgentsとMCPサーバーが一般提供開始。
* **2026-08-07**: DCM Projectsが一般提供開始。
* **2026-08-04**: ゲートウェイ監視およびA/Bテスト機能、ならびにマルチパーティ承認機能が一般提供開始。
* **2026-08-03**: Trust CenterにおけるAI Securityスキャナーパッケージとタブが一般提供開始。
* **2026-07-30**: 動的テーブルの適応型リフレッシュ（Adaptive refresh）モードが一般提供開始。
* **2026-03-26**: Snowflake Data Clean Roomsのアップデートおよび、動的テーブルの新しいSCHEDULER属性が一般提供開始。
* **2026-03-02**: ハイブリッドテーブルの料金体系を簡素化。
