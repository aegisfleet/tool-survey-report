...
Redmineは活発に開発が継続されており、定期的にアップデートがリリースされています。直近では、機能追加とUI改善を目的としたメジャーアップデートと、セキュリティ修正を目的としたメンテナンスアップデートが頻繁に行われています。

*   **2025-11-01: 2要素認証の必須化**
    *   公式サイト `Redmine.org` において、スパム対策とセキュリティ強化のため、全ユーザーを対象に2要素認証（2FA）が必須となりました。
    *   [https://www.redmine.org/news/157](https://www.redmine.org/news/157)

*   **2025-09-21: Redmine 6.1.0 リリース**
    *   70件近い改善を含む機能豊富なメジャーアップデート。主な新機能は以下の通りです。
        *   **リアクション機能**: チケットやニュース、フォーラム投稿に絵文字でリアクションを追加可能に。
        *   **OAuth2 プロバイダ対応**: RedmineをOAuth2プロバイダとして機能させることが可能に。
        *   **UI/UXの改善**: ユーザーのイニシャルをアバターとして表示する機能、長いチケットページをスクロールしても件名が追従する「スティッキーヘッダー」、コピーボタンの追加など、多くの改善が含まれています。
        *   **テキストフォーマットの強化**: CommonMarkの警告表示拡張や、最近更新されたWikiページを表示するマクロ `{{recent_pages}}` が追加されました。
    *   このリリースに伴い、Redmine 5.0 はサポート終了（EOL）となりました。
    *   [https://www.redmine.org/news/156](https://www.redmine.org/news/156)

*   **2025-09-21: メンテナンスリリース (6.0.7, 5.1.10, 5.0.14)**
    *   複数のセキュリティ脆弱性（認証フォームでの情報保存、2FAの情報漏洩など）の修正を含む、合計16件のバグ修正が行われました。
    *   [https://www.redmine.org/news/155](https://www.redmine.org/news/155)

*   **2025-07-07: メンテナンスリリース (6.0.6, 5.1.9, 5.0.13)**
    *   Rubyライブラリ `net-imap` の脆弱性(CVE-2025-43857)対応や、Rack 3.1.14以上との互換性向上など、合計32件のバグ修正が行われました。
    *   [https://www.redmine.org/news/154](https://www.redmine.org/news/154)

*   **2025-04-20: メンテナンスリリース (6.0.5, 5.1.8)**
    *   SVGアイコンへの移行に伴う改善や、RTL言語のサポート向上など、合計32件のバグ修正が行われました。
    *   [https://www.redmine.org/news/153](https://www.redmine.org/news/153)
