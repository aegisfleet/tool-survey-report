...
quick_summary:
  ...
  target_users:
    ...
    - マーケター
    - EC事業者
  latest_highlight: 2026年8月にAIエージェント「Ask Advisor」やAIによるレポート作成機能を追加
  update_frequency: 高
evaluation:
  score: 85
  base_score: 70
...
| **AI機能** | エージェント機能 | ◎<br><small>Ask Advisor搭載</small> | △<br><small>アドバイザー機能なし</small> | △<br><small>アドバイザー機能なし</small> | ◎<br><small>Copilot統合</small> |
