...
* **音声の非対応**: 2025年後半時点で、動画に音声を付与する機能は提供されていない。
* **日本語情報の不足**: 公式サイトやドキュメントは英語が中心で、日本語のサポートや情報が限られている。
* **商用利用の制限**: 無料プランおよびLiteプランでは商用利用が許可されておらず、ウォーターマークが付与される。

## **6. 料金プラン**

* **Freeプラン**: $0/月。月8ビデオ（ドラフトモード）、非商用利用のみ、ウォーターマークあり。
* **Liteプラン**: $7.99/月 (年払時)。月3,200クレジット、非商用利用のみ、ウォーターマークあり。
* **Plusプラン**: $23.99/月 (年払時)。月10,000クレジット、商用利用可能、ウォーターマークなし。
* **Unlimitedプラン**: $75.99/月 (年払時)。月10,000クレジット + リラックスモードでの無制限利用、商用利用可能、ウォーターマークなし。
* **Enterpriseプラン**: 要問い合わせ。月20,000クレジット以上、最高優先度の処理、入力データを学習に利用しない設定など。
...
* **調査対象**: Google検索、日本語ブログ記事、X(Twitter)等。
* **ポジティブな評価**:
    * 「テキストから手軽に高品質な動画が作れる」
    * 「操作が直感的で、初心者でもすぐに使える」
...
* **January 15, 2025: Introducing Ray2**: 新しいマルチモーダルアーキテクチャに基づき、Ray1の10倍の計算能力を持つ動画生成モデルRay2を導入。
(注: 2025年7月以降、公式サイトのChangelogに大きな機能リリースは記載されていません)
