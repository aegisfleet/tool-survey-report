...
|:---:|:---|:---:|:---:|:---:|
| **データアクセス** | 自然言語クエリ | ◎ | ◎ | ×<br><small>コード記述が必要</small> |
| **統合** | MCP対応 | ◎ | △<br><small>独自コネクタ</small> | × |
| **対象** | M365データ | ◎ | ◎<br><small>多岐にわたるSaaS</small> | ◎ |
| **導入** | 手軽さ | ◎<br><small>npm install</small> | △<br><small>エンタープライズ契約</small> | △<br><small>アプリ登録・実装</small> |
