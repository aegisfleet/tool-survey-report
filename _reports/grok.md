...
* **無料プラン**: Xプラットフォームの全ユーザーが、機能制限付きで利用可能。
* **有料プラン**:
  * **SuperGrok**: 月額$30.00。Grok 4.1などの最新モデルや高度な機能を利用できるスタンドアロンのサブスクリプション。
  * **SuperGrok Heavy**: 月額$300.00。最も強力なGrok 4 Heavyへのアクセス、マルチエージェント推論、拡張トークン制限、開発者ツールを含む。
  * **Grok Business**: 月額$30/ユーザー。ビジネス向けのプラン。
* **課金体系**: サブスクリプションベース。APIは別途従量課金。
* **無料トライアル**: 明記されていない。
