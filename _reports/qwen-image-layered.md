...
* **アーキテクチャ**: Python/PyTorchベースのローカル実行可能なAIモデル。
* **主要コンポーネントとデータフロー**:
  * 入力画像とテキストプロンプト（省略時は自動生成）を受け取り、指定された層数のRGBAレイヤー画像群を出力する。
* **特筆すべき要素技術**:
  * Transformerアーキテクチャを用いた画像生成モデル。
  * vLLM-Omniによる推論効率化にも対応。
...
* **2026-01-15**: vLLM-Omniのサポートに関するドキュメントをREADMEに追加。
* **2025-12-31**: vLLM-Omniによるサポートを追加（推論の効率化）。
* **2025-12-30**: マルチGPUのサポートおよび推論パイプライン（app_multigpu.py）を追加。
...
(出典: [GitHub Commits](https://github.com/QwenLM/Qwen-Image-Layered/commits/main))
