...
quick_summary:
  ...
  target_users:
    ...
    - 企業広報
    - マーケター
  latest_highlight: 2026年3月にGroupfile（法人向けサービス）にて「フォルダ公開機能」を提供開始
  update_frequency: 高
evaluation:
  score: 80
  base_score: 70
...
* **フォルダ公開機能 (Groupfile)**: 姉妹サービスの法人向け「Groupfile」にて、フォルダ単位で資料を整理・検索可能なポータルとして一括公開できる機能。
...
| **法人向け**<br>(Groupfile) | 月額38,000円〜 | ユーザー数無制限。フォルダ単位での資料ポータル構築（公開）、セクション整理・全文検索対応など。 |
...
* **2026-03-18**: **Groupfile フォルダ公開機能** - 姉妹サービスのGroupfileにて、フォルダ単位で資料ポータルを構築できる「フォルダ公開機能」の提供を開始。
...
(出典: [ドクセルマガジン](https://www.docswell.com/magazine/) / [PR TIMES（株式会社アプルーシッド プレスリリース一覧）](https://prtimes.jp/main/html/searchrlp/company_id/60342))
