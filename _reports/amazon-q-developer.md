...
quick_summary:
  ...
  target_users:
    ...
    - クラウドエンジニア
    - エンタープライズ
  latest_highlight: 2026年5月に新規登録停止・2027年4月末サポート終了を発表、Kiroへの移行が開始
  update_frequency: 高
evaluation:
  score: 82
  base_score: 70
...
* **2026-05-15**: **新規登録停止および2027年4月末サポート終了（End-of-Support）の発表**: 新規アカウント・サブスクリプション登録がブロックされ、既存サブスクリプションとIDEプラグインは2027年4月30日をもってサポート終了予定。スペック駆動開発型IDE「Kiro」への移行プロセスを開始。(出典: [AWS Documentation](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/doc-history.html))
