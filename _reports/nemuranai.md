...
|:---:|:---|:---:|:---:|:---:|:---:|
| **基本機能** | テスト作成 | ◎<br><small>AIとSHIFTノウハウで自動設計</small> | ◎<br><small>UI操作での記録・ノーコード</small> | ◎<br><small>AIによる要素検出・ノーコード</small> | ◎<br><small>ローコード・AI自己修復</small> |
| **カテゴリ特定** | 実行体制 | ◎<br><small>24時間365日の完全自動・無人監視</small> | ◯<br><small>スケジューリング等での自動実行</small> | ◯<br><small>クラウド環境での自動実行</small> | ◯<br><small>クラウド環境での自動実行</small> |
...
| **Autify** | No-CodeテストSaaS | 誰でも簡単にテスト作成可能、UI操作による直感的な記録 | 複雑なシナリオや条件分岐には工夫が必要 | アジャイル開発、Webサービス全般、非エンジニア主体でのテスト |
