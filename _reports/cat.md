...
* **2026-02-26**: 添付ファイルの一覧ダウンロード機能の追加、テスト実行画面の列フィルター対象の改善など（Ver 4.20.7）
* **2026-01-07**: 工程のアーカイブ機能追加、添付ファイル一括ダウンロード/削除機能、テスト実行画面のフィルタ強化（AND/OR）、課題登録時の確認メッセージ追加など（Ver 4.20.6）
