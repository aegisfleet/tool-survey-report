...
quick_summary:
  ...
  target_users:
    ...
    - 開発者
    - データサイエンティスト
  latest_highlight: CLI v1.1.0 リリース
  update_frequency: 中
evaluation:
  score: 83
  base_score: 70
...
|:---:|:---|:---:|:---:|:---:|
| **ファイル解析** | ファイルタイプ判定 | ◎<br><small>AIによる高精度なテキスト/バイナリ判定</small> | ×<br><small>非対応</small> | ×<br><small>非対応</small> |
| **セキュリティ** | 脆弱性スキャン | ×<br><small>ファイル種別の特定のみ</small> | ◯<br><small>依存関係の脆弱性スキャンに特化</small> | ◎<br><small>コンテナ・IaC・OS等の包括的スキャン</small> |
| **性能** | 推論/スキャン速度 | ◎<br><small>数msレベルで一定</small> | ◯<br><small>高速</small> | ◯<br><small>対象により変動するが概ね高速</small> |
| **エコシステム** | プログラム組み込み | ◎<br><small>Python/JS/Rust API完備</small> | △<br><small>CLIベースが主</small> | ◯<br><small>CLI中心だがCI/CD連携が強力</small> |
