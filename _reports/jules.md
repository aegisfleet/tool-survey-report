...
tags:
  ...
  - "コーディング支援"
  - "CLI"
description: "Googleが開発した、ソフトウェア開発ワークフロー全体を支援するAI搭載コーディングエージェント。"
---
# **Google Jules 調査レポート**
...
* **カテゴリ**: AIコーディング支援
* **概要**: Googleが開発したAI搭載のコーディングエージェント。コード生成、バグ修正、テスト作成、パフォーマンス改善など、ソフトウェア開発のワークフロー全体を支援する。
...
* (現時点で、具体的な導入企業名や詳細な事例は広く公開されていない。)
...
* **公式サポート**: ドキュメントサイト内にフィードバックやサポートを求める[連絡先ページ](https://jules.google/docs/contact/)が用意されている。
...
* **GitHub Copilot**:
    ...
    *   **Julesとの違い**: Julesは自律的にタスクを実行し、完了後にプルリクエストを提出する「エージェント」。開発者はJulesの作業を待つ間、他のことに集中できる。ワークフローが根本的に異なる。
    *   **選択基準**: リアルタイムのコーディング支援が必要な場合はCopilot、定型的なタスクを自動化したい場合はJulesが適している。
