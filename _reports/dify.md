...
quick_summary:
  ...
  target_users:
    ...
    - スタートアップ
    - プロダクトマネージャー
  latest_highlight: 2026年5月にv1.14.1をリリース。セキュリティ強化やワークフロー安定性が向上
  update_frequency: 高
evaluation:
  score: 88
  base_score: 70
...
* **調査対象**: G2.com (ボットプロテクションにより直接リンクは省略。記載内容は過去のデータに基づく), 公式サイト掲載のX(Twitter)投稿
...
* **2026-05-12**: v1.14.1をリリース。セルフホスト環境のセキュリティ強化やワークフローの安定性を向上。
* **2026-04-29**: v1.14.0をリリース。
