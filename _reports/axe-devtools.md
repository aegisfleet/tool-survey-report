...
quick_summary:
  ...
  target_users:
    ...
    - "QAエンジニア"
    - "アクセシビリティ専門家"
  latest_highlight: "2025年後半にAIチャットボット「Axe Assistant」と「Axe MCP Server」を導入"
  update_frequency: "高"
...
* **2025-09-09**: **axe DevTools Linter 4.10.10** リリース。LiquidJSのサポート追加およびLinux ARMプロセッサのサポート。
