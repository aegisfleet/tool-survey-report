...
developer: ultraworkers
official_site: https://github.com/ultraworkers/claw-code
date: '2026-04-01'
...
quick_summary:
  ...
  target_users:
    - 開発者
    - AIエンジニア
  latest_highlight: 2026年8月にサンドボックス環境でのmapping自動フォールバックが修正されるなど、堅牢性が向上
  update_frequency: 高
evaluation:
  score: 80
  base_score: 70
...
* **公式サイト**: [https://github.com/ultraworkers/claw-code](https://github.com/ultraworkers/claw-code)
* **関連リンク**:
...
(出典: [GitHubリポジトリ 変更履歴](https://github.com/ultraworkers/claw-code/commits/main/))
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **基本機能** | 自律的なコード生成・実行 | △<br><small>現在基盤を構築中</small> | ◎<br><small>高度な推論と実行</small> | ◎<br><small>エンドツーエンドでの自律開発</small> | ◎<br><small>完全自律・サンドボックス</small> |
...
| **拡張性** | 外部連携 | ◯<br><small>Ollama等のローカル連携</small> | ◎<br><small>MCP標準対応</small> | ◎<br><small>MCP Marketplace対応</small> | ◎<br><small>各種統合・MCP対応</small> |
