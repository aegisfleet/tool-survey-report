...
quick_summary:
  ...
  target_users:
    ...
    - 成長企業
    - MFシリーズ利用者
  latest_highlight: 2026年4月に「日次勤怠」画面での新しいアラートや管理コンソールでの利用状況確認機能を追加
...
* **アーキテクチャ**: クラウド完結型SaaS
* **主要コンポーネントとデータフロー**:
  * ブラウザやスマホアプリ、ICカードなどから打刻データがクラウドサーバーに送信される。
  * クラウド上で集計され、マネーフォワード クラウド給与等の他サービスとAPI連携でデータが共有される。
* **特筆すべき要素技術**:
  * マネーフォワード クラウドシリーズ間でのシームレスなAPI連携。
...
* **2026-04-14**: 管理コンソールでクラウド勤怠の利用状況が確認できるようになりました
* **2026-03-24**: 月別データ・出勤簿データの出力条件を拡張しました
* **2026-03-19**: 「日次勤怠」画面に表示されるアラートを追加しました

(出典: [マネーフォワード クラウド勤怠 お知らせ](https://biz.moneyforward.com/support/attendance/news/))
