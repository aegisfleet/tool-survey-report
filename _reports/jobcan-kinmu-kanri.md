...
quick_summary:
  ...
  target_users:
    ...
    - スタートアップ
    - 多様な働き方の企業
  latest_highlight: 2025年1月に工数管理プランを大幅リニューアルし、5月にサービス開始15周年キャンペーンを実施
  update_frequency: 中
evaluation:
  score: 78
  base_score: 70
...
* **工数管理**: プロジェクトやタスクごとの工数を記録し、業務内容を可視化。2025年1月のリニューアルで機能が大幅にアップデートされた。
...
* **公式サポート**:
  ...
  * 無料プランではチャットサポート利用不可。
  * SATO-GROUPとの提携による「ジョブカン“無料de顧問”」サービスを提供。
...
* **外部サービス連携**:
  ...
  * **その他**: SmartHR（人事労務）, Payme（給与前払い）, Akerun, workhub（入退室管理）
...
* **2025-05-22**: ジョブカンシリーズ15周年！『ジョブカン勤怠管理』、「ジョブカン15周年記念キャンペーン」を実施
* **2025-01-20**: 工数管理をより細かくより使いやすく！『ジョブカン勤怠管理』の「工数管理プラン」機能を大幅アップデート
* **2025-01-17**: 株式会社DONUTSとSATO-GROUP業務提携による『ジョブカン勤怠管理』『ジョブカン給与計算』で「ジョブカン“無料de顧問”」を付帯サービスとして開始
* **2024-10-21**: 『ジョブカン勤怠管理』が経済産業省の定める「特定技能制度(繊維工業)における勤怠管理の電子化要件を満たすシステム」に採択
* **2024-09-17**: 『ジョブカン勤怠管理』とビットキーの「workhub」が連携を開始　入退室履歴で自動出退勤打刻が可能、労働時間の把握が容易に
* **2026-02**: **工数管理プランの分析機能強化**
  * 工数実績のグラフ表示（円グラフ・棒グラフ）やカスタムレポートに対応し、プロジェクト別・スタッフ別の工数分析機能が強化された。
* **2025-11**: **各種打刻手段の追加・連携強化**
  * LINE連携打刻やクラウド打刻機等の機能改善が行われ、多様な働き方における利便性が向上した。
* **2025-08**: **管理者用ダッシュボードのUI刷新**
  * 管理画面のUIが改善され、アラート（36協定超過・打刻漏れ等）の視認性および操作性が向上した。

(出典: [公式サイト ニュースリリース](https://www.donuts.ne.jp/news/category/jobcan/) より要約)

## **17. 類似ツールとの比較**

### **17.1 機能比較表 (星取表)**

| 機能カテゴリ | 機能項目 | 本ツール | KING OF TIME | マネーフォワード クラウド勤怠 | SmartHR |
|:---:|:---|:---:|:---:|:---:|:---:|
...
| **コスト** | 最低価格 | ◎<br><small>¥200〜/機能選択可</small> | ◯<br><small>¥300/ユーザー</small> | ◯<br><small>基本料金が必要</small> | ◯<br><small>要見積もり</small> |
| **連携** | 給与連携 | ◎<br><small>主要ソフト網羅</small> | ◯<br><small>CSV連携中心</small> | ◎<br><small>シリーズ連携強力</small> | ◎<br><small>SmartHRエコシステム連携強力</small> |

### **16.2 詳細比較**

| ツール名 | 特徴 | 強み | 弱み | 選択肢となるケース |
|---------|------|------|------|------------------|
| **本ツール** | 機能選択式の柔軟な料金体系 | コストパフォーマンスとシフト管理機能の強さ。LINE/Slack打刻。 | 管理者画面のUIがやや煩雑。 | コストを抑えたい企業、シフト管理が重要なサービス業、柔軟な打刻方法を求める企業。 |
