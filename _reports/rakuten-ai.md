...
* **美容室探しを支援するAIエージェント「Rakuten Beauty Agent」ベータ版提供開始 (2025年12月24日)**: ユーザーに合わせたサロン選びをサポートするAIエージェントのベータ版をリリース。
* **GENIACプロジェクトで国内最大級の高性能AIモデルを公開 (2025年12月18日)**: GENIACプロジェクトの一環として、国内最大級となる高性能なAI基盤モデルを開発・公開したことを発表。
* **HPのPCに「Rakuten AI」を搭載 (2025年11月11日)**: HP Japanとの協業により、HP製のPCにオンデバイスで動作する「Rakuten AI」の機能を搭載することを発表。
