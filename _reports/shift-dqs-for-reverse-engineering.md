...
quick_summary:
  ...
  target_users:
    ...
    - 開発エンジニア
    - プロジェクトマネージャー
  latest_highlight: 2026年6月に「SHIFT DQS for メンテナンスサポート」の提供開始を発表
...
| **可視化** | ドキュメント自動生成 | ◎<br><small>46種類のドキュメントを一括・継続生成</small> | △<br><small>プロンプトによる個別生成が必要</small> | △<br><small>膨大な人手と時間がかかる</small> |
| **支援範囲** | 再構築支援 | ◯<br><small>フォワードエンジニアリング連携</small> | ◎<br><small>GPT-5/Claude 4.5等による実装からテストまでの統合支援</small> | ◯<br><small>SIerの総合力による</small> |
| **運用支援** | 保守・運用自動化 | ◎<br><small>AIOpsによる次世代SRE運用</small> | ◯<br><small>自律エージェント(Copilot Agents)による一部自動化</small> | ×<br><small>人手での運用が主</small> |
| **非機能要件** | 導入スピード | ◯<br><small>AI活用により短縮されるが個別対応</small> | ◎<br><small>SaaSとして即座に利用可能</small> | ×<br><small>人海戦術のため長期化</small> |
