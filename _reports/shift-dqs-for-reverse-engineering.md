...
| 機能カテゴリ | 機能項目 | 本ツール | GitHub Copilot Workspace | 従来のSIerによるリバースエンジニアリング |
|:---:|:---|:---:|:---:|:---:|
...
| **GitHub Copilot Workspace** | 開発者向けのAIネイティブな統合開発環境・エージェント | 開発者の手元で即座に動作し、コードの理解から修正・テストまで自律的に支援 | システム全体の俯瞰的な業務仕様書の自動生成などは得意ではない | 開発チームが内製でシステムの理解を深めながら、アジャイルにリファクタリングを進める場合 |
